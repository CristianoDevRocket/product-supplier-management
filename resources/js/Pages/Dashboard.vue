        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold text-blue-600">{{ stats.openOrders }}</p>
                        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500">Processando</p>
                            <p class="mt-2 text-3xl font-bold text-orange-600">{{ stats.processingOrders }}</p>
                        </div>
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-2xl font-bold text-emerald-600">{{ formatCurrency(stats.totalRevenue) }}</p>
                        </div>
                        <div class="flex-shrink-0 bg-emerald-600 rounded-full p-3">
